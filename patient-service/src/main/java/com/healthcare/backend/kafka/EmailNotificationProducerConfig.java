...
public class EmailNotificationProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, EmailNotification> emailNotificationProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, EmailNotification> emailNotificationKafkaTemplate() {
